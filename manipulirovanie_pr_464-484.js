...
// 469 задание
//1 Дан массив с работниками. Выведите элементы этого массива в виде HTML таблицы.  
...
// 470 задание 
//2 Дана таблица размером 2 на 2. Дана также кнопка. Сделайте так, чтобы по нажатию на кнопку таблица увеличивалась на один ряд и на одну колонку. 
...
// 472 задание
//1 Дан список. Сделайте так, чтобы по клику на кнопку в список добавлялся новый элемент.
...
// 473 задание 
//1 предотвратить переход по ссылке с помощью preventDefault
...
// 475 задание 
//1 Модифицируйте код так, чтобы текст абзаца менялся не по потери фокуса, а по мере ввода текста в инпут.
...
// 481 задание 
//1 Много элементов с кнопками показа
...
// 484 задание 
//5 Модифицируйте задачу так, чтобы в конце каждой li также стояла ссылка 'перечеркнуть', с помощью которой можно будет перечеркнуть текст данного тега li. 
...
// 484 задание 
//3 Модифицируйте задачу так, чтобы под списком был инпут, с помощью которого можно будет добавить новый элемент в конец списка ul. Сделайте так, чтобы новые li также можно было редактировать. 
//   let input = document.createElement('input');
...
// // 481 задание 
//6 Дан массив с работниками. Выведите этих работников в HTML таблице.  
...
// 481 задание 
//9 Сделайте под таблицей 3 инпута и кнопку для добавление нового работника реализуйте редактирование ячеек для вновь добавленных работников. Пусть в инпуты вводятся имя, возраст и зарплата, и по нажатию на кнопку новый работник добавляется в таблицу. 
